...
public class BookLuceneTest {
	...
	public void testCreateIndex() throws IOException {
		...
		doc1.add(new Field("id", book1.getId().toString(), Store.YES,
				Index.NOT_ANALYZED));
		doc1.add(new Field("title", book1.getTitle(), Store.YES, Index.ANALYZED));
		doc1.add(new Field("author", book1.getAuthor(), Store.YES,
				Index.ANALYZED));
		doc1.add(new Field("content", book1.getContent(), Store.YES,
				Index.ANALYZED));

		// 建立Document
		Document doc2 = new Document();

		// Store指定Field是否需要存储,Index指定Field是否需要索引
		doc2.add(new Field("id", book2.getId().toString(), Store.YES,
				Index.NOT_ANALYZED));
		doc2.add(new Field("title", book2.getTitle(), Store.YES, Index.ANALYZED));
		doc2.add(new Field("author", book2.getAuthor(), Store.YES,
				Index.ANALYZED));
		doc2.add(new Field("content", book2.getContent(), Store.YES,
				Index.ANALYZED));
	 ...
	 */
	@Test
	public void testSearchBook() throws ParseException, CorruptIndexException,
		...
		// QueryParser(Version.LUCENE_36,"author",analyzer);//在作者的索引中搜索
